...
if number >= 0:
    ...
    if ((number%10)-10) == 0:
        print(f"Last digit of {number} is {((number%10)-10)} and is 0")
    elif ((number%10)-10) < 6 & ((number%10)-10) != 0:
        print(f"Last digit of {number} is {((number%10)-10)} and is less than 6 and not 0")
    else:
        print(f"Last digit of {number} is {((number%10)-10)} and is greater than 5")
